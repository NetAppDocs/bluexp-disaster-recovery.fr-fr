...
Pour plus de détails sur le fait d'ignorer la protection, reportez-vous à la https://docs.netapp.com/us-en/bluexp-disaster-recovery/use/failover.html["Échec des applications ovre vers un site distant"].
...
Pour plus de détails sur le fait d'ignorer la protection, reportez-vous à la https://docs.netapp.com/us-en/bluexp-disaster-recovery/use/drplan-create.html["Créer un plan de réplication"].
