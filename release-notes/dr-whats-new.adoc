...
[role="lead"]
Découvrez les nouveautés de la prévisualisation de la reprise d'activité BlueXP.
...
Cette version de BlueXP Disaster Recovery comprend les mises à jour suivantes :
