...
image:dr-architecture-diagram-onprem-to-onprem2.png["Schéma illustrant l'architecture de l'infrastructure de service BlueXP Disaster Recovery pour VMware"]
