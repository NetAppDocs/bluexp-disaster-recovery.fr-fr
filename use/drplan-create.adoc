...
+
image:dr-plan-create-apps-vms3.png["Capture d'écran montrant la page Ajouter un plan de réplication > applications à répliquer"]
...
+
image:dr-plan-resource-mapping.png["Plan de réplication, onglet mappage de ressources"]
...
*** *Hôte cible* (facultatif)
*** *Cluster cible* (facultatif)
*** *Dossier VM cible* (facultatif) : permet de créer un nouveau dossier racine pour stocker les machines virtuelles sélectionnées.
